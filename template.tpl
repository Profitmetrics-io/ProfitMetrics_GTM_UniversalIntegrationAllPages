...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "PM Universal Integration - All pages",
  "categories": [
    "ADVERTISING",
    "ANALYTICS",
    "ATTRIBUTION",
  ...
  "description": "IMPORTANT: This tag must trigger on \"All pages\". This tag supports Google Consent Mode by default. No additional consent requird.",
  "containerContexts": [
    "WEB"
  ]
}
